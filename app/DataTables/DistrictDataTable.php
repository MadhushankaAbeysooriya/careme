...
class DistrictDataTable extends DataTable
{
    ...
    {
        return $model->with('province')->newQuery();
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('province.name')->data('province.name')->title('Province'),
