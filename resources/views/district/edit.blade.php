            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item ">District Management</li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control @error('province_id') is-invalid @enderror"
                                    name="province_id" value="{{ old('province_id') }}" id="province_id" required>
                                    @foreach ($province as $item)
                                    <option value="{{ $item->id }}" {{$district->province_id == $item->id ?
                                        'selected':''}}>
                                        {{ $item->name }}
                                    </option>
                                    @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                is-invalid @enderror" name="name" value="{{ $district->name }}" id="name"
                                    autocomplete="off">
